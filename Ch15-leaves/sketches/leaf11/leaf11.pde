...
void drawOneLeaf() {
   ...
   PVector pG1 = makeControlPoint(-0.25, -0.15,  0.15, -0.25, -0.15, 0.0);
   PVector pG2 = makeControlPoint( 0.25, -0.15,  0.15, -0.25, -0.15, 0.0);
   PVector pH1 = makeControlPoint(-0.25, -0.15,  0.15,  0.25,  0.0, 0.15);
   PVector pH2 = makeControlPoint( 0.25, -0.15,  0.15,  0.25,  0.0, 0.15);
   ...
   stroke(196, 66, 63);  // red
   elipse(sG1.x, sG1.y, 15, 15);
   elipse(sG2.x, sG2.y, 15, 15);
   line(sA.x, sA.y, sG1.x, sG1.y);
   line(sB.x, sB.y, sG2.x, sG2.y);
   stroke(64, 135, 36);  // green
   elipse(sH1.x, sH1.y, 15, 15);
   elipse(sH2.x, sH2.y, 15, 15);
